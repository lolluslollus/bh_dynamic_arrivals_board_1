...
Another big thank you goes out to badgerrhax for the idea.
            ...
            ["Align2Platform"] = "Bahnsteig entlang",
            ["ArrivalsAllCaps"] = "ANKÜNFTE",
            ["Auto"] = "Auto",
            ["ColourScheme"] = "Farbenschema",
            ["displays"] = "Tafel",
            ["DynamicDisplaysOff"] = "Dynamische Tafel AUS",
            ["DynamicDisplaysOn"] = "Dynamische Tafel EIN",
            ["Cargo"] = "Fracht",
            ["CompanyNamePrefix1"] = "Ein Dienst von ",
            ["DeparturesAllCaps"] = "ABFAHRTEN",
            ["Due"] = "An",
